            ...
            <div class="alert alert-info"><?php echo $this->lang->line('cat_new_required'); ?></div>	
                ...
                <?php echo form_error('categoryTitle', '<div class="alert">', '</div>'); ?>									
                    ...
                    <?php 	$data = array(
						  ...
						  'id'          => 'categoryTitle',
						  'class'       => 'span4',
						  'value'		=> set_value('categoryTitle', $c['categoryTitle'])
						);
                ...
                <?php echo form_error('categorySlug', '<div class="alert">', '</div>'); ?>									
					...
					<div class="controls">
						 <?php 	$data = array(
						  ...
						  'id'          => 'categorySlug',
						  'class'       => 'span4',
						  'value'		=> set_value('categorySlug', $c['categorySlug'])
						);
               	...
               	<div class="control-group">		
					...
					<div class="controls">
						...
						echo form_textarea($data, set_value('categoryDescription', $c['categoryDescription'])); ?>
